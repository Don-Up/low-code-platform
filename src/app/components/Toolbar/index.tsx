...
export default function Toolbar() {
    ...
    return <div className={"h-20 flex bg-white select-none"}>
        ...
        <div className={"leading-20 ml-1 hover:cursor-pointer"} onClick={() => dispatch(UndoActionCreators.undo())}>{t("undo")}</div>
        <img src={"images/redo.svg"} className={"w-5 ml-4"} alt={"redo"}/>
        <div className={"leading-20 ml-1 hover:cursor-pointer"} onClick={() => dispatch(UndoActionCreators.redo())}>{t("redo")}</div>
